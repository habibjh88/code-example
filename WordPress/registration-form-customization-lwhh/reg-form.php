...
// 1. Add new field in registration form
//==============================================
...
// 3. Save user data from registration from
//==============================================
...
// 4. Add Extra field (Phone Number)
//==============================================
...
?>
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="number" class="regular-text ltr" id="phone_number" name="phone_number" value="<?= esc_attr(get_user_meta($user->ID, 'phone_number', true)) ?>" title="Phone Number">
                <p class="description">
                    <?php _e("Phone Number", "reg-form"); ?>
                </p>
            </td>
...
add_action('show_user_profile', 'rfp_user_profile_phone_number');
add_action('edit_user_profile', 'rfp_user_profile_phone_number');


// 4. Update extra field from backend for current user and admin
//==============================================
...
add_action('personal_options_update', 'rfp_update_phone_number'); //update from current user
add_action('edit_user_profile_update', 'rfp_update_phone_number'); //update from admin
