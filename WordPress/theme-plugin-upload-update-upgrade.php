...
@ Plugin upload funtionality | theme upload | upgrade

See the below file - Everything is here in this file

wp-admin\update.php 

Or check below code all code is here from the above file
*/
